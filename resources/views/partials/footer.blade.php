<footer class="bg-gray-100" aria-labelledby="footer-heading">
    ...
    <div class="container py-16 sm:py-24 lg:py-32">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-y-16">
            ...
            <div>
                <h3 class="text-sm font-semibold leading-6 text-gray-900">Other links</h3>
                <ul role="list" class="mt-6 space-y-4">
                    <li>
                        <a href="{{ route('contributions.create') }}" class="text-sm leading-6 text-gray-600 hover:text-gray-900">Write with us</a>
                    </li>
                </ul>
            </div>
        </div>
